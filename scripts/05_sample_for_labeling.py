...
def _snippet(jfull: str, anchor: str, before: int, after: int) -> str:
    idx = jfull.find(anchor)
    if idx < 0:
        return ""
    return jfull[max(0, idx - before): idx + after].replace("\n", " ").replace("\r", " ")
    ...
    with args.out.open("w", encoding="utf-8-sig", newline="") as fh:
        ...
        for r in sampled:
            ...
            w.writerow({
                ...
                "jtitle": r["jtitle"],
                "main_snippet": _snippet(r["jfull"], "主", 0, 400)[:400],
                ...
                "gt_behaviors": "", "gt_drug_levels": "",
                "gt_sentence_months": "", "gt_detention_days": "",
                "gt_probation_months": "",
                "gt_art17_1": "", "gt_art17_2": "", "gt_art59": "",
                "gt_recidivism": "", "gt_can_convert_to_fine": "",
                "notes": "",
            })
